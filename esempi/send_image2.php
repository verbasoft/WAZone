<?PHP
//
// Esempio di invio messaggio multimediale WA con Immagine (PNG) e Testo
//
...
// essere nel formato 3934812345678 (preceduti dal prefisso internazionale '39' x l'italia)

$wa_number = 'destinatario';


// url del file multimediale da inviare al destinatario
$urlmedia = "https://dev2.verbasoft.net/docs/software.png";
...
$API = $WA->SendMedia($wa_number, $urlmedia, "Prova con testo!!");
